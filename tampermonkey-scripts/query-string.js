...
// @version      1.3
// @description  Додає до текстового запиту пошуку гугл текст "-и -site:*.ru". Зменшує кількість москальськомовних сайтів у результатах пошуку. Добре доповнює існуючі додатки "Лагідна українізація" та "stopRU". Попередження: додатково перезавантажує сторінку, щоб додати ці параметри до запиту.
